---
layout: subpage
title: "基調講演 | ICKT 2027"
permalink: /keynote/
---

<div class="content-wrapper keynote-editorial">
  ...
  <div class="editorial-profile">
    ...
    <div class="profile-text-column">
      ...
      <div class="editorial-quote-box">
        <span class="eq-label">講演題目</span>
        <p class="eq-title">「未定」</p>
      </div>
    </div>
  </div>
  ...
  <section class="editorial-section">
    <h2 id="abstract">講演概要</h2>
    <div class="editorial-body">
      <p>本講演の概要は決定次第、順次掲載いたします。</p>
      <p>（現在、講演詳細を準備中です。続報をお待ちください。）</p>
    </div>
  </section>
  ...
  <section class="editorial-section">
    ...
    <div class="editorial-bio">
      <p>
        1974年京都大学工学部情報工学科卒業、1976年同大学大学院工学研究科修士課程修了、1978年同博士後期課程中退。1979年神戸大学教養部助手、1986年同大学工学部助教授、1994年同教授を経て、2001年京都大学大学院情報学研究科教授。2017年3月に京都大学を定年退職し、同年4月より京都大学名誉教授。2020年福知山公立大学情報学部教授に就任し、2023年度をもって同大学を退職。
      </p>
      <p>
        専門はデータベース、情報検索、マルチメディア情報システム、Web情報システム。データベースモデル、オブジェクト指向データベース、マルチメディアコンテンツ処理、Web情報検索などの研究に従事。
      </p>
      <p>
  ...
  <div class="editorial-back">
    <a href="/" class="back-link">← ICKT 2027 トップへ戻る</a>
  </div>
